...
@class SBAppSwitcherOrbGestureSettings, SBChestnutController, SBFluidSwitcherAnimationSettings;

@interface SBAppSwitcherSettings : SBUISettings
{
    long long _simplicityOptions;
    _Bool _hasCachedEffectiveKillAffordanceStyle;
    long long _cachedEffectiveKillAffordanceStyle;
    SBChestnutController *_chestnutController;
